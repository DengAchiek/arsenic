(function () {
  ...
  function footerHTML() {
    return [
      ...
      '<ul class="space-y-2.5 text-sm" style="color:var(--muted)">',
      '<li><a href="tel:+254700000000" class="hover:text-white transition-colors">+254 700 000 000</a></li>',
      '<li><a href="mailto:hello@arsenicenergies.com" class="hover:text-white transition-colors">hello@arsenicenergies.com</a></li>',
      '<li>Nairobi, Kenya</li>',
      '</ul>',
